   ...
   const stories: IStoryCard[] = [
      {
         ...
         imageUrl: `${amazonS3bucket}/short+stories/series/What+happens+in+the+dark+-+Chapter+1.png`,
      ...
      },
      {
         ...
         imageUrl: `${amazonS3bucket}/short+stories/microfiction/The+spark+of+creativity.png`,
      ...
      },
      {
         ...
         imageUrl: `${amazonS3bucket}/short+stories/microfiction/Would+you+be+somebody+else.png`,
      ...
      },
      {
         ...
         imageUrl: `${amazonS3bucket}/short+stories/flash+fiction/Maybe+she+was+lucky.png`,
      ...
      },
      {
         ...
         imageUrl: `${amazonS3bucket}/short+stories/flash+fiction/A+guess+in+the+reflection.png`,
